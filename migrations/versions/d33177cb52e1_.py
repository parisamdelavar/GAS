...
Revision ID: d33177cb52e1
Revises: 
Create Date: 2021-12-20 12:48:27.415543
...
def upgrade():
    ...
    op.create_table('notificatio_types',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=60), nullable=False),
    ...
    sa.Column('max_location', sa.Integer(), nullable=False),
    sa.Column('sponsor_id', sa.Integer(), nullable=True),
    sa.Column('notification_type', sa.Integer(), nullable=True),
    sa.Column('type', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['notification_type'], ['notificatio_types.id'], ),
    sa.ForeignKeyConstraint(['sponsor_id'], ['sponsors.id'], ),
    sa.ForeignKeyConstraint(['type'], ['scenario_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('roles')
    op.drop_table('notificatio_types')
